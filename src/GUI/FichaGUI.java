...
public class FichaGUI extends javax.swing.JFrame {
    ...
    for (Aluno aluno : lista) {
        modelo.addRow(new Object[]{
            aluno.getNome(),
            aluno.getCpf(),
            formato.format(aluno.getDataNascimento().toInstant().atZone(java.time.ZoneId.systemDefault()).toLocalDate()),
            aluno.getTelefone(),
            aluno.getEndereco(),
            aluno.getEmail()
        });
    ...
    private void initComponents() {
        ...
        setName("Gestão Academia 1."); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome ", "CPF", "Data de Nascimento", "Telefone", "E-mail", "Endereco"
            }
        ) {
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
       ...
       novoAluno.setCpf(this.txtCPF.getText());
       novoAluno.setDataNascimento(new GregorianCalendar());
       novoAluno.setEmail(this.txtEmail.getText());
       novoAluno.setEndereco(this.txtEndereco.getText());
       novoAluno.setNome(this.txtNomeAluno.getText());
       novoAluno.setTelefone(this.txtTelefone.getText());
       
       FichaDAO ficha = new FichaDAO();
       ficha.inserir(novoAluno);
       limparCampos();
       carregarTabela();
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        // TODO add your handling code here:
        System.out.println("botão alterar apertado");
    }//GEN-LAST:event_btnAlterarActionPerformed

    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        // TODO add your handling code here:
        System.out.println("botão deletar apertado");
